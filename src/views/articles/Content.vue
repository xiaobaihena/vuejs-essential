  ...
  <div class="panel-body vote-box text-center">
    ...
    <div class="voted-users">
      <div class="user-lists">
        <span v-for="likeUser in likeUsers" v-bind:key="likeUser.likeUserId">
          <!-- 点赞用户是当前用户时，加上类 animated 和 swing 以显示一个特别的动画  -->
          <img :src="user && user.avatar" class="img-thumbnail avatar avatar-middle" :class="{ 'animated pulse' : likeUser.uid === 1 }">
        </span>
      </div>
